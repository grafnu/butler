...
class MocketDevice:
    ...
    def handle_handshake_state(self, data):
        # Handshake state is in 'udmi' subfolder within the payload wrapper
        ...
        self.publish_uufi(None, "config", response_payload["udmi"], "udmi", transaction_id=transaction_id, target_principal=principal)

    def handle_cloud_message(self, data):
        # Cloud data is wrapped in 'cloud' key within 'payload'
        payload_wrapper = data.get("payload", {})
    ...
    def handle_update_config(self, data):
        ...
        # Look inside the 'update' subfolder for the config within 'payload'
        payload_wrapper = data.get("payload", {})
        update_config = payload_wrapper.get("update", {})

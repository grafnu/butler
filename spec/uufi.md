...
- **Mandatory Envelope Fields:** For MQTT, all published messages MUST include the following fields in the top-level envelope: `projectId`, `transactionId`, `publishTime`, `source`, `nonce`, and `principal`.
- **Cloud Model Service:**
